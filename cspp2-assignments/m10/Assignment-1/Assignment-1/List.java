...
public class List {
    ...
    */
    ...
    /**
     * { conatins checks for nummber present in list or not }.
     *
     ...
     * @param      item  The item (number)
     *
     * @return     { returns element present in list }
     */
    ...
    /**
     * { add function add numbers to the list }.
     *
     * @param      index  The index
     * @param      item   The item(number)
     */
    ...
    /**
     * { count function returns number of times the element repeated in list}.
     *
     * @param      item  The item
     *
     * @return     { returns the count of number }
     */
